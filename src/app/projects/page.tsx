          ...
          <section className="flex flex-col justify-between p-3 bg-bg-section rounded-md">
            ...
            <div className="flex flex-row">
              <div className="pr-3 border-r-[1px] border-clr-text-table flex flex-col gap-1">
                ...
                <p className="text-xs text-clr-text-table">Advanced Balance</p>
              </div>
              <div className="pl-3 flex flex-col gap-1">
                <p className="font-bold text-sm">$ 48.451</p>
                <p className="text-xs text-clr-text-table">Outstand Balance</p>
              </div>
            </div>
          </section>
          ...
          {projects.map(async (project: Projects) => {
            ...
            return (
              ...
              >
                ...
                <td className="p-2">{findUser(project?.projectManagerId)}</td>
